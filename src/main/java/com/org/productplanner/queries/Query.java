...
public class Query {
	...
	public static final String SAVE_X_RECEIPT="insert into TABLE_X_RECEIPT(OBJID,X_RECEIPT_ID,X_CUSTOMER_ID,X_OPENING_BAL,PREVIOUS_OPENING_BAL,OPENING_ADVANCE_AMT,X_RECEIVED_AMT,X_CLOSING_BAL,X_TRANSACTION_TYPE,X_COMMENTS,X_RECEIPT_DATE,X_ADVANCE_AMOUNT) values(?,?,?,?,?,?,?,?,?,?,?,?)";
