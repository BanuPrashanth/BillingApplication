...
public class Query {
	...
	// public static final String UPDATE_OPENING_BALANCE="UPDATE CUSTOMER_TBL SET OPENING_BALANCE = ? WHERE CUSTOMER_ID= ? ";
	 ...
	 * Receipt
	 */
	public static final String SAVE_RECEIPT="insert into TABLE_RECEIPT(OBJID,RECEIPT_ID,CUSTOMER_ID,OPENING_BAL,PREVIOUS_OPENING_BAL,OPENING_ADVANCE_AMT,RECEIVED_AMT,CLOSING_BAL,TRANSACTION_TYPE,COMMENTS,RECEIPT_DATE,ADVANCE_AMOUNT) values(?,?,?,?,?,?,?,?,?,?,?,?)";

	public static final String SAVE_X_RECEIPT="insert into TABLE_X_RECEIPT(OBJID,X_RECEIPT_ID,X_CUSTOMER_ID,X_OPENING_BAL,X_PREVIOUS_OPENING_BAL,X_OPENING_ADVANCE_AMT,X_RECEIVED_AMT,X_CLOSING_BAL,X_TRANSACTION_TYPE,X_COMMENTS,X_RECEIPT_DATE,X_ADVANCE_AMOUNT) values(?,?,?,?,?,?,?,?,?,?,?,?)";
